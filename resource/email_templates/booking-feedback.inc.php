<div style="max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div
        ...
        <h1 style="color: #0f172a; font-size: 24px; font-weight: bold; margin: 0; text-align: center;">Thank you for your feedback!
        </h1>
    </div>
    ...
    <div
        ...
        <div style="margin-bottom: 24px;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tr>
                    <td style="padding: 12px 0; font-weight: bold; color: #0f172a; font-size: 16px;">Total Receivables</td>

<div style="max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div
        ...
        <h1 style="color: #0f172a; font-size: 24px; font-weight: bold; margin: 0; text-align: center;">Booking Cancelled
        </h1>
    </div>
    ...
    <div
        ...
        <div style="margin-bottom: 24px;">
            <h2 style="color: #0f172a; font-size: 18px; font-weight: bold; margin: 0 0 12px 0;">Booking Cancelled</h2>
            <p style="margin: 0; color: #64748b;">We're sorry to inform you that your booking has been cancelled. Below is a summary of your booking.</p>
        </div>
        ...
        <div style="margin-bottom: 24px;">
            <h3 style="color: #0f172a; font-size: 16px; font-weight: bold; margin: 0 0 12px 0;">Cancellation Details</h3>
            <table style="width: 100%; border-collapse: collapse;">
                <tr>
                ...
                <tr>
                    <td style="padding: 8px 0; color: #64748b; border-bottom: 1px solid #e2e8f0;">Cancellation Service Fee
                    </td>
                    <td
                        style="padding: 8px 0; text-align: right; font-weight: 500; color: #334155; border-bottom: 1px solid #e2e8f0;">
                        {cancellation_fee}</td>
                ...
                <tr>
                    <td style="padding: 12px 0; font-weight: bold; color: #0f172a; font-size: 16px;">Total Refund</td>
    ...
    <div
        ...
        <ul style="padding-left: 20px; margin: 0 0 24px 0; color: #64748b;">
            <li style="margin-bottom: 8px;">If Total Refund is greater than 0 THB, you will receive a refund in your account wallet.</li>
            <li style="margin-bottom: 8px;">Cancellations must be made at least 24 hours in advance for a full refund.</li>

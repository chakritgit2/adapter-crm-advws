<div style="max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div
        ...
        <h1 style="color: #0f172a; font-size: 24px; font-weight: bold; margin: 0; text-align: center;">Thank You for
            Using ห้องซ้อม.com</h1>
    </div>
    ...
    <div
        ...
        <div style="margin-bottom: 24px;">
            <h2 style="color: #0f172a; font-size: 18px; font-weight: bold; margin: 0 0 12px 0;">Thank you for using our
                service!</h2>
            <p style="margin: 0; color: #64748b;">We're excited to know how you feel about {branch_name}. Please take a
                moment to share your feedback so we can continue to improve the service for you in the future.</p>

            <!-- Call to Action -->
            <div style="text-align: center; margin: 12px 0px;">
                <a href="{booking_feedback_url}"
                    style="display: inline-block; background-color: #2563eb; color: #ffffff; text-decoration: none; padding: 12px 24px; border-radius: 6px; font-weight: 500; font-size: 16px; margin-top:12px;">รีวิวห้องซ้อม</a>
            </div>
        </div>
    ...
    <div style="text-align: center; padding: 24px 0;">
        ...
        <div style="margin-bottom: 16px;">
            ...
            <a href="{terms_of_service_url}"
                style="color: #64748b; text-decoration: none; font-size: 14px; margin: 0 8px;">Terms
                of Service</a>
        </div>
        <p style="margin: 0; color: #94a3b8; font-size: 12px;">This is an automated email. Please do not reply to this.

        ...
        <header class="bg-white border-b border-slate-200 sticky top-0 z-50 print:hidden">
            <nav class="container mx-auto px-4 lg:px-8 flex justify-between items-center h-20">
                <div class="flex items-center gap-3">
                    <!-- <img src="http://floorprosummit.com/img/floorprosummit-logo.jpg" alt="FloorProSummit Logo" class="h-10"> -->
                    <img src="/img/logo.png" alt="ADC Logo" class="h-10">
                    <div class="w-px h-6 bg-slate-200"></div>
                    <a href="/" class="text-xl font-normal text-slate-900 notosan">
                        <p>{{config.appName}}</p>
                    </a>
                    <!-- divider -->
                    <!-- <ul class="hidden md:flex items-center gap-6">
                        <li><div class="w-px h-6 ml-3 bg-slate-200"></div></li>
                        <li>
                            <a href="/dashboard" class="text-sm font-medium text-slate-900 notosan">Portfolio</a>
                        </li>
                        <li><div class="w-px h-6 bg-slate-200"></div></li>
                        <li>
                            <a href="https://mailmanager.igetticket.com/login" target="_blank" class="text-sm font-medium text-slate-900 notosan">Email Manager</a>
                        </li>
                    </ul> -->
                </div>
            ...
            <div class="container mx-auto px-4 lg:px-8 py-6">
                <div class="flex flex-col md:flex-row justify-center items-center gap-6">
                    <div class="text-sm text-slate-500 text-center">
                        &copy;
                        <?= date('Y') ?> {{config.appName}}. All rights reserved.
                    </div>
                </div>
            </div>
        </footer>

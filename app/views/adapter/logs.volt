...
<div class="container mx-auto px-4 lg:px-8 py-8 space-y-8">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-slate-500 mt-1">Monitor external connection tests and API endpoint requests with diagnostic context.</p>
        </div>
    ...
    <section class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
        <div class="px-6 py-4 border-b border-slate-200 flex items-center justify-between"><div><h2 class="font-semibold text-slate-900">External connection log</h2><p class="text-xs text-slate-500 mt-1">Connection target and outcome for tests and adapter queries.</p></div><span class="text-xs text-slate-500">Latest {{ connectionLogs|length }} entries</span></div>
